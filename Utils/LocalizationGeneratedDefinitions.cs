...
namespace BaseLib.Utils
{
    ...
    public abstract class LocalizationDefinitionBase : LocalizationDefinition
    {
    ...
    public class CardLoc : LocalizationDefinitionBase
    {
    ...
    public class RelicLoc : LocalizationDefinitionBase
    {
        public required string Title { get; init; }
    ...
    public class PotionLoc : LocalizationDefinitionBase
    {
        public required string Title { get; init; }
        public required string Description { get; init; }
        public required string SelectionScreenPrompt { get; init; }
    ...
    public class PowerLoc : LocalizationDefinitionBase
    {
        public required string Title { get; init; }
        public required string Description { get; init; }
        public required string SelectionScreenPrompt { get; init; }
    ...
    public class OrbLoc : LocalizationDefinitionBase
    {
        public required string Title { get; init; }
        public required string Description { get; init; }
        public string? SmartDescription { get; init; }
    ...
    public class EnchantmentLoc : LocalizationDefinitionBase
    {
        public required string Title { get; init; }
        public required string Description { get; init; }
    ...
    public class AfflictionLoc : LocalizationDefinitionBase
    {
        public required string Title { get; init; }
        public required string Description { get; init; }
        public required string ExtraCardText { get; init; }
    ...
    public class EncounterLoc : LocalizationDefinitionBase
    {
        public required string Title { get; init; }
    ...
    public class CharacterLoc : LocalizationDefinitionBase
    {
        public required string Title { get; init; }
        public required string Description { get; init; }
    ...
    public class ModifierLoc : LocalizationDefinitionBase
    {
        public required string Title { get; init; }
        public required string Description { get; init; }
        public string? AdditionalRestSiteHealText { get; init; }
    ...
    public class MonsterLoc : LocalizationDefinitionBase
    {
